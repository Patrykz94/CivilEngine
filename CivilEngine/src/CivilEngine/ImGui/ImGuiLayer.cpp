...
namespace Civil {
	...
	void ImGuiLayer::OnAttach()
	{
		...
		// TEMPORARY: should eventually use CivilEngine key codes
	...
	void ImGuiLayer::OnEvent(Event& event)
	{
		...
		dispatcher.Dispatch<MouseScrolledEvent>(CE_BIND_EVENT_FN(ImGuiLayer::OnMouseScrolledEvent));
		...
		dispatcher.Dispatch<WindowResizeEvent>(CE_BIND_EVENT_FN(ImGuiLayer::OnWindowResizedEvent));
	}
